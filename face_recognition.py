...
class Face_Recognition:
    def __init__(self,root):
        ...
        f_lbl.place(x=0, y=440, width=1530, height=325)
         ...
         # button in between 
        b1_1=Button(self.root,text="RECOGNIZE YOUR FACE",cursor="hand2",command=self.face_recog,font = ("times new roman", 30, "bold"),bg= "darkgreen", fg="white")
        b1_1.place(x=0,y=380,width=1530,height=60)
    
    #=========== attendance =================
    def mark_attendance(self,i,r,n,d):
        with open("aviruddh.csv","r+",newline="\n") as f:
    ...
    def face_recog(self):
        ...
        faceCascade=cv2.CascadeClassifier(r"C:\Users\User\OneDrive\Desktop\project grp-62\Real-Time-Facial-Recognition\haarcascade_frontalface_default.xml")
        clf=cv2.face.LBPHFaceRecognizer_create()
        clf.read(r"C:\Users\User\OneDrive\Desktop\project grp-62\Real-Time-Facial-Recognition\classifier.xml")
